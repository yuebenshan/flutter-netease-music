...
class Settings extends Model {
  ...
  Settings(this._preferences) {
    // _preferences.getInt(_key_theme_mode) ??
    // _preferences.getInt(_key_theme) ??
    _themeMode = ThemeMode.values[0]; /* default is system */
    _theme = quietThemes[0]; /* default is NetEase Red */
